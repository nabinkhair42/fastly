    ...
    <div className="max-w-2xl flex flex-col justify-center items-center h-screen mx-auto px-6 xl:px-0">
      <div className="text-center space-y-6">
        ...
        <div className="text-left space-y-3">
          <h2 className="text-2xl font-semibold">Get started by cloning the repository</h2>
          <p className="text-muted-foreground">
            A fully-featured SaaS starter kit built with Next.js, TypeScript, MongoDb and Tailwind
            CSS.
          </p>
        </div>
