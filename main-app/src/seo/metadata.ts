...
export const siteConfig = {
  name: "My SaaS App - Built on Fastly",
  description:
    "A sample SaaS application demonstrating the power of Fastly - a comprehensive starter kit for building modern web applications with Next.js, TypeScript, and cutting-edge UI components.",
...
export const metadata: Metadata = {
  ...
  category: "technology",
  classification: "Sample SaaS Application",
  referrer: "origin-when-cross-origin",
  applicationName: "My SaaS App",
  generator: "Next.js + Fastly",
  abstract: "Sample SaaS application built on Fastly foundation",
