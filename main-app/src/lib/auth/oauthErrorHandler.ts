...
export const handleOAuthError = (error: string | null) => {
  ...
  switch (error) {
    case 'use_email_login':
      toast.error('Please use Email to login. This account was created with Email authentication.');
      break;
    ...
    case 'oauth_account_exists':
      toast.error('This account was created with OAuth. Please use OAuth to login.');
      break;
    default:
