          ...
          <FormItem>
            ...
            <FormControl>
              <div className="relative">
                ...
                <ToggleButton isActive={showNewPassword} onClick={onToggleShowNewPassword} />
              </div>
            </FormControl>
            <FormDescription>
              Choose a strong password with at least 8 characters, including letters, numbers, and
              symbols.
            </FormDescription>
            <FormMessage />
          </FormItem>
