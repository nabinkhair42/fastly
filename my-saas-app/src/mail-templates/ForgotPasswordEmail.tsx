      ...
      <Body style={{ fontFamily: 'Arial, sans-serif', color: '#333' }}>
        ...
        >
          ...
          <Section>
            ...
            <Text style={{ fontSize: '16px', lineHeight: '1.5' }}>
              We received a request to reset the password for your Fastly
              account. No worries - it happens to the best of us! If you made
              this request, click the button below to securely reset your
              password.
            </Text>
            <Text
              style={{ fontSize: '16px', lineHeight: '1.5', marginTop: '10px' }}
            >
              For your security, this reset link will expire in 24 hours. If you
              didn&apos;t request this password reset, you can safely ignore
